         ...
         <tr class="hover:bg-gray-50">
          ...
          <td class="py-4 px-6">
           <span class="px-3 py-1 rounded-full text-sm
            @if($item->status == 'Approved') bg-yellow-100 text-yellow-800 px-3 py-2 rounded-lg inline-block text-sm
            @elseif($item->status == 'Pending') bg-blue-100 text-blue-800 px-3 py-2 rounded-lg inline-block text-sm
