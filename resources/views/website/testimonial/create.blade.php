...
<head>
    ...
    <title>Menambahkan Testimonial - Admin Dashboard</title>
        ...
        <div class="ml-64 flex-1">
            <div class="p-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    <h1 class="text-2xl font-bold">Menambahkan Testimonial</h1>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm">
                    ...
                    <form action="{{ route('website.testimonial.store') }}" method="POST" class="space-y-6">
                        @csrf
                        <div>
                            <label for="nama" class="block text-sm font-medium text-gray-700 mb-2">Nama</label>
                            <input type="text" name="nama" id="nama" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nama pelanggan">
                        </div>

                        <div>
                            <label for="asal" class="block text-sm font-medium text-gray-700 mb-2">Asal</label>
                            <input type="text" name="asal" id="asal" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan asal pelanggan">
                        </div>

                        <div>
                            <label for="rating" class="block text-sm font-medium text-gray-700 mb-2">Rating</label>
                            <input type="number" name="rating" id="rating" min="1" max="5" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan rating pelanggan">
                        </div>

                        <div>
                            <label for="testimoni" class="block text-sm font-medium text-gray-700 mb-2">Testimonial</label>
                            <textarea name="testimoni" id="testimoni" rows="4" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan testimoni pelanggan"></textarea>
                        </div>
