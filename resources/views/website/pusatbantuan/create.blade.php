                    ...
                    <form action="{{ route('website.pusatbantuan.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="jawaban" placeholder="Masukkan jawabannya" rows="4"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required></textarea>
                            </div>
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    <button type="button" onclick="selectCategory(this, 'FAQ')"
                                        class="px-4 py-2 rounded-lg border border-gray-300 hover:bg-yellow-100">FAQ</button>
                                    <button type="button" onclick="selectCategory(this, 'Panduan')"
                                        class="px-4 py-2 rounded-lg border border-gray-300 hover:bg-yellow-100">Panduan</button>
                                    <button type="button" onclick="selectCategory(this, 'Layanan & Kebijakan')"
                                        class="px-4 py-2 rounded-lg border border-gray-300 hover:bg-yellow-100">Layanan
                                        & Kebijakan</button>
                                </div>
                            ...
                            <div class="flex justify-end space-x-2">
                                ...
                                <button type="submit"
                                    class="px-6 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600">Tambah</button>
                            </div>
                        </div>
                    </form>
                </div>
